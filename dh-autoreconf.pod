...
exclude stuff from autoreconf, read the L<dh_autoreconf(1)> manual page. For
information on how to prevent unwanted file deletions, read the manual page
of L<dh_autoreconf_clean(1)>.
